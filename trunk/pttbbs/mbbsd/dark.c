...
"                                                [1;36m¢®[1;33m ¢ë[1;37m: [1;35m      ´«Ãä[m");
	...
	}else
	{
		...
		{ pprints(21,0,"   \033[1;33m¡»[1;31m§A«ù¬õ¦â´Ñ\033[m");i++;move(cury[my],curx[mx]); }
		if(!i && currutmp->color=='0')
		{ pprints(21,0,"   \033[1;33m¡»[1;36m§A«ù¶Â¦â´Ñ\033[m");i++;move(cury[my],curx[mx]); }
    ...
    case -1:
    case -2:
        if(currutmp->turn=='w'){ move(22,0);clrtoeol();prints("[1;31m§AÄ¹¤F.. ¯u¬O®¥³ß~~[m");}
        else {move(22,0);clrtoeol();prints("[1;31m¿é±¼¤F°Õ.....¤U¦¸Åý¥L¦n¬Ý!![m");}
        break;
    case -3:
