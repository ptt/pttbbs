...
void strip_move_control_sequence(char *s);
...
unsigned int set_friend_bit(const userinfo_t *me, const userinfo_t *ui);
void set_friend_bit_hint(const unsigned int *entries, int count);
