...
void setafile(char *buf, const char *boardname, const char *fname);
...
void add_to_utmp_user(int uslot, int unum);
void remove_from_utmp_user(int uslot, int unum);
int utmp_apply_user(int unum, int (*callback)(userinfo_t *uentp, void *arg), void *arg);
userinfo_t *utmp_find(int unum);
...
int get_online_session(int uslot, int *out_pid, int *out_uid, char *out_userid);
int set_online_session_friends(int uslot, int expected_pid, int expected_uid,
                               const unsigned int *entries, int count);
int get_online_session_detail(int uslot, int *out_pid, int *out_uid, char *out_userid,
