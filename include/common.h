...
#define ERR_PASSWD      "密碼不對或無此帳號。請檢查大小寫及有無輸入錯誤。"
...
/* 水球模式 邊界定義                                     */
/* ----------------------------------------------------- */
#define WB_OFO_USER_TOP		1
#define WB_OFO_USER_NUM		5
#define WB_OFO_USER_BOTTOM	(WB_OFO_USER_TOP + WB_OFO_USER_NUM - 1)
#define WB_OFO_USER_LEFT	28
#define WB_OFO_MSG_TOP		7
#define WB_OFO_MSG_BOTTOM	14
